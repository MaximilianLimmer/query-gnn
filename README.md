...
<p align="center">
  <img src="plots/gnn_report_plot.png" width="600" title="Predicted vs Actual Runtime">
  <br>
  <em>Figure 1: Predicted vs. Actual Runtime (Log Scale). The tight clustering along the diagonal demonstrates high model reliability across four orders of magnitude.</em>
</p>---
